...
#This function calculates the coordinates of a line based on its slope and intercept.
...
#This function calculates the average slope and intercept of the detected lines and uses make_coordinates 
# to get the left and right lane lines.
...
#This function converts the input image to grayscale, applies Gaussian blur, and then 
...
#This function draws the detected lines on a black image.
...
def region_of_interest(image):
    ...
    polygons = np.array([
        [(200,height),(1100,height),(550,250)]])          # Triangle polygon because cv2.fillPoly expects an array of polygons.
...
#This part reads frames from a video, applies the lane detection algorithm.
...
# displays the result in a window named 'Output'
